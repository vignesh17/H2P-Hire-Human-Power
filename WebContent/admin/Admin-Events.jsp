...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Events<a href="../admin/Admin-Submitjob.jsp" >Add</a></h1>
                </div>
            </div>
				<div id="event"><h2>Event List</h2></div>
				  ...
				  <script type="text/javascript">
					function delete_event(id){
						...
						$.ajax({
			    			...
			    			success : function(responseText) 
			    			{
			    				window.location.href = "Admin-Events.jsp"
			    		    }	
			    	});
