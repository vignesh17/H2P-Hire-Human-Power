...
<!-- Top Navigation: Left Menu -->
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Event Owners<a href="../user/managerregister.jsp" >Add</a></h1>
                </div>
            </div>
				<div id="eventOwners"><h2>Event Owners</h2></div>
    			...
    			<script type="text/javascript">
					...
					function delete_owner(id){
						...
						$.ajax({
			    			...
			    			success : function(responseText) 
			    			{
			    				window.location.href = "Admin-EventOwners.jsp"
			    		    }	
			    	});
...
<div id="eventsView"><h2>All Posted Events</h2></div>
<script type="text/javascript">
	function view_events(id){
		var user_id= "id_manager="+id;
