		...
		<div class="container">
			<div class="row">
				<div class="canditate-profile">
					...
					function view_owner(id,firstname,lastname,contactnumber,email){
						var data_userid=""+id;
						var data_firstname=""+firstname;
						var data_lastname=""+lastname;
						var data_contactnumber=""+contactnumber;
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="matter">
										...
										<span><%= out.println("data_userid") %></span>
									</div>	
									<div class="matter">
										<label>LAST NAME
										<button type="submit" value="Submit" class="icon" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
