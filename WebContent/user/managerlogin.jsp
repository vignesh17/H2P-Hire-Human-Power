			...
			<div class="row">
				<div class="col-sm-offset-2 col-md-8 col-sm-8  col-xs-12">
					<div class="form">
						...
						<form class="form-horizontal" action="<%=request.getContextPath()%>/loginController" method="post">
							<fieldset>
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input type="password" class="form-control" id="password" placeholder="Enter your password" value="" name="password" required="" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-12 confirmation">
										...
										<a href="<%=request.getContextPath() %>/user/forgotPassword.jsp" class="colorLink subHeadingText icon-wrap pull-right">Forgot password?</a>
									</div>
								</div>
								...
								<p>Don't have an account? <a href="<%=request.getContextPath() %>/user/managerregister.jsp">Register as a manager</a><br><a href="<%=request.getContextPath() %>/user/employeeregister.jsp">Register as an employee</a></p>
							</fieldset>
						</form>
					</div>
				</div>
