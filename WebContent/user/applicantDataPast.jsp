...
<td>${a.skills}</td>
<td><button type="button" class="btn btn-info" onclick="location.href='<%=request.getContextPath()%>/user/ratings.jsp?user_id=${a.register_id }&event_id=<%=request.getParameter("event_id") %>'">Give Ratings</button></td>
</tr>
</t:forEach>
</table>
