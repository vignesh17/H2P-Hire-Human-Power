...
<t:forEach items="${sessionScope.list_of_all_review}" var="a">
<tr>
<td>${a.eventname}</a></td>
<td>${a.eventDate}</td>
<td>${a.manager}</td>
...
<td>${a.comments}</td>
	...
	<div class="button">
						<a href="<%=request.getContextPath() %>/user/applicantDataSkilled.jsp" class="btn btn-primary btnus">BACK TO PROFILE</a>
	</div>			
