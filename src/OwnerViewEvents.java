 ...
 */
@WebServlet("/OwnerViewEvents")
public class OwnerViewEvents extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OwnerViewEvents() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {  
		   ...
		   String USER = "root";
		   String PASS = "root";
		   String managerToView = request.getParameter("id_manager");
		   System.out.println(""+managerToView);
		   ...
		   try{
		      ...
		      String sql = "SELECT * FROM event where manager_id='"+managerToView+"'";
		      //int event_id = 0;
