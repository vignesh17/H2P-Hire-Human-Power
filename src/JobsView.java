...
/**
 * Servlet implementation class JobsView
 */
@WebServlet("/JobsView")
public class JobsView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {  
		   ...
		   String USER = "root";
		   String PASS = "root";
		   String jobsToView = request.getParameter("id_user");
		   System.out.println(""+jobsToView);
		   ...
		   try{
		      ...
		      String sql = "SELECT * from event where event_id in (select event_id from jobapplication where user_id='"+jobsToView+"')";
		      //int event_id = 0;
